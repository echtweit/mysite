import { version, hasInjectionContext, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, defineComponent, h, Suspense, Transition } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/unctx/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, useRoute as useRoute$1, RouterView } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, joinURL } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/ufo/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/@unhead/ssr/dist/index.mjs';
import { getActiveHead, createServerHead as createServerHead$1 } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/@unhead/shared/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///Users/jprecht/Documents/Projects/Portfolio/portfolio/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-25c909c4.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-68477b2b.mjs').then((m) => m.default || m)
  },
  {
    name: "portfolio",
    path: "/portfolio",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/portfolio-859b7298.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-6c1c9942.mjs').then((m) => m.default || m))
};
