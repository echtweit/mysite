...
const styles = {
  "pages/about.vue": () => import('./_nuxt/about-styles.b6982de8.mjs').then(interopDefault),
  "pages/portfolio.vue": () => import('./_nuxt/portfolio-styles.9a75f3d2.mjs').then(interopDefault),
  ...
  "layouts/default.vue": () => import('./_nuxt/default-styles.0385b167.mjs').then(interopDefault)
};
