...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function $s(){return new sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:kr(),fragmentShader:`
		...
		`,blending:tn,depthTest:!1,depthWrite:!1})}function Js(){return new sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:kr(),fragmentShader:`
...
`)}function rf(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let r=0;r<n;r++){const s=i.getActiveAttrib(e,r),o=s.name;let a=1;s.type===i.FLOAT_MAT2&&(a=2),s.type===i.FLOAT_MAT3&&(a=3),s.type===i.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function ii(i){return i!==""}function oa(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function la(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const sf=/^[ \t]*#include +<([\w\d./]+)>/gm;function Dr(i){return i.replace(sf,of)}const af=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function of(i,e){let t=Ce[e];if(t===void 0){const n=af.get(e);if(n!==void 0)t=Ce[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Dr(t)}const lf=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ca(i){return i.replace(lf,cf)}function cf(i,e,t,n){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function ua(i){let e="precision "+i.precision+` float;
precision `+i.precision+" int;";return i.precision==="highp"?e+=`
#define HIGH_PRECISION`:i.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:i.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function uf(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===Ta?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===zo?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Wt&&(e="SHADOWMAP_TYPE_VSM"),e}function hf(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Yn:case jn:e="ENVMAP_TYPE_CUBE";break;case Bi:e="ENVMAP_TYPE_CUBE_UV";break}return e}function df(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case jn:e="ENVMAP_MODE_REFRACTION";break}return e}function ff(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Ra:e="ENVMAP_BLENDING_MULTIPLY";break;case sl:e="ENVMAP_BLENDING_MIX";break;case al:e="ENVMAP_BLENDING_ADD";break}return e}function pf(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function mf(i,e,t,n){const r=i.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=uf(t),c=hf(t),u=df(t),f=ff(t),d=pf(t),m=t.isWebGL2?"":tf(t),v=nf(s),x=r.createProgram();let p,h,b=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(ii).join(`
`)),o=Dr(o),o=oa(o,t),o=la(o,t),a=Dr(a),a=oa(a,t),a=la(a,t),o=ca(o),a=ca(a),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(b=`#version 300 es
...
`,Zf={__name:"CanvasComp",setup(i){let e=["#545252","#91dad3","#ffe083","#ffcac6","#c5b2b2"];e=e.map(g=>new Ge(g));let t=null;const{width:n,height:r}=Fo(),s=new Xf,o=new Et(9,600/600,.1,1e3);o.position.x=1,o.position.y=-1,o.position.z=2;var a=new to({alpha:!0});a.setPixelRatio(window.devicePixelRatio),a.setSize(n.value,r.value),a.setClearColor(0,0),t=new qf(o,a.domElement),t.enableDamping=!0,(()=>{t&&(t.dispose(),t=null)})(),document.body.appendChild(a.domElement);const c=new Gi(1.4,1.4,300,300,300),u=new sn({side:It,uniforms:{time:{value:0},uColor:{value:e},resolution:{value:new it},transition:{value:{}}},wireframe:!1,fragmentShader:jf,vertexShader:Kf}),f=new Yt(c,u);s.add(f);const d=Ma(()=>n.value/r.value);function m(){a.setSize(n.value,r.value),a.render(s,o)}function v(){var g;if(o.type==="PerspectiveCamera"&&(o.aspect=d.value),o.type==="OrthographicCamera"){const R=(g=o.userData)==null?void 0:g.frustumSize;o.left=R*d.value/-2,o.right=R*d.value/2}o.updateProjectionMatrix()}var x=0,p=5e-4;const h=()=>{x+=p,f.material.uniforms.time.value=x,requestAnimationFrame(h),a.render(s,o)};xa(()=>{v(),m()}),Or(()=>{h()});const b=_o();return Br(b,g=>{let R=b.name;p=.0015,setTimeout(()=>{p=5e-4},500),R==="index"?e=["#545252","#91dad3","#ffe083","#ffcac6","#c5b2b2"]:R==="about"?e=["#545252","#ffcac6","#ffe083","#545252","#91dad3"]:R==="portfolio"&&(e=["#ffcac6","#91dad3","#ffcac6","#ffcac6","#c5b2b2"]),e=e.map(y=>new Ge(y)),f.material.uniforms.uColor.value=e},{deep:!0,immediate:!0}),(g,R)=>(Nr(),Fr("div",null,[Xt("canvas",Yf,null,512)]))}},$f=Ir(Zf,[["__scopeId","data-v-49ca57d1"]]);const ga=Mn("Jakob Precht - Frontend Dev"),Jf=Mn("This is my rag-tag portfolio");go({title:ga,meta:[{name:ga,content:Jf}]});const Qf={},ep={class:"content"};function tp(i,e,t,n,r,s){const o=Ro,a=$f;return Nr(),Fr("div",ep,[ri(o),vo(i.$slots,"default"),ri(a)])}const rp=Ir(Qf,[["render",tp]]);export{rp as default};
