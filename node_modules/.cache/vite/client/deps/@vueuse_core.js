...
function useBrowserLocation({ window: window2 = defaultWindow } = {}) {
  ...
  const buildState = (trigger) => {
    ...
    return reactive2(__spreadValues$n({
      trigger,
      state: state2,
      length,
      origin
...
function useCloned(source, options = {}) {
  ...
  if (!manual && (isRef2(source) || typeof source === "function")) {
    watch2(source, sync, __spreadProps$a(__spreadValues$m({}, options), {
      deep,
      immediate
    }));
  } else {
...
function useDraggable(target, options = {}) {
  ...
  return __spreadProps$62(__spreadValues$g({}, toRefs(position)), {
    position,
...
function usePointer(options = {}) {
  ...
  return __spreadProps$22(__spreadValues$62({}, toRefs(state)), {
    isInside
  });
}
...
function useWindowScroll({ window: window2 = defaultWindow } = {}) {
  ...
  const x = ref2(window2.scrollX);
  const y = ref2(window2.scrollY);
  useEventListener(
    window2,
    "scroll",
    () => {
