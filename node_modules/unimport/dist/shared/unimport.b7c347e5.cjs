...
const vueTemplate = require('./unimport.fdf6c6cb.cjs');
const fs = require('fs');
...
function createUnimport(opts) {
  ...
  return {
    ...
    toExports: async (filepath, includeTypes = false) => vueTemplate.toExports(await ctx.getImports(), filepath, includeTypes),
